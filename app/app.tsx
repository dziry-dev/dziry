...
/**
 * Everything the framework currently supports, on one screen.
 *
...
export default (
    // `cn` keeps the signal visible to the compiler, which turns each conditional
    // into style-table writes. A plain string would already have lost the link.
    <body className={cn({ light: isLight })}>
        <div className={cn('app', { compact: isCompact })}>
            <div className="header">
                <div>
                    <div className="title">dziri</div>
                    <div className="subtitle">
                        Taffy lays out · Skia paints · SDL3 owns the window
                    </div>
                </div>
