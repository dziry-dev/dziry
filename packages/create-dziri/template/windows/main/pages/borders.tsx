  ...
  return (
    <div className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-3 rounded-xl bg-zinc-900 p-6">
        ...
        <div className="text-xs text-zinc-400">
          rounded-t-2xl · rounded-l-2xl · rounded-br-2xl · rounded-tl-2xl rounded-br-2xl — four
          fields in the style table, one per corner, so the longhands say what CSS says
        </div>
        <div className="flex flex-row items-start gap-3">
          ...
          <div className="h-16 w-16 rounded-tl-2xl rounded-br-2xl bg-teal-500" />
