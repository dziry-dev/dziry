...
export const LAYERS: Layer[] = [
  ...
  },
  {
    ...
    roots: [
      ...
      "native-src/dziry-engine/src/lib.rs",
    ],
    blurb:
  ...
  },
  {
    ...
    label: "Engine",
    roots: [
      "native-src/dziry-engine/src/",
      "native-src/dziry-engine/examples/",
      "native-src/dziry-engine/tests/",
      "native-src/dziry-engine/build.rs",
    ],
    blurb:
...
export const STAGES: Stage[] = [
  ...
  // --- the frame -----------------------------------------------------------
  {
    ...
    files: ["native-src/dziry-engine/src/lib.rs", "native-src/dziry-engine/src/error.rs"],
    invariant:
  ...
  },
  {
    ...
    files: ["native-src/dziry-engine/src/tables.rs", "native-src/dziry-engine/src/engine.rs"],
  },
  {
    id: "layout",
    phase: "frame",
  ...
  },
  {
    ...
    files: ["native-src/dziry-engine/src/paint.rs", "native-src/dziry-engine/src/text.rs"],
  },
  {
    id: "events",
    phase: "frame",
...
export const GUARDS: Guard[] = [
  ...
  },
  {
    ...
    what: "Lays out the same html+css in dziry and in the browser at the same viewport, then compares every box.",
    oracle: "headless Chrome",
  },
  {
    script: "spec-audit",
  ...
  },
  {
    ...
    what: "What CSS exists versus what dziry supports, bucketed as supported / unsupported / committed non-goal.",
    oracle: "mdn-data",
  },
  {
  ...
  },
  {
    ...
    what: "How each HTML element renders in dziry versus the browser — the table that specifies the UA stylesheet.",
    oracle: "headless Chrome",
  },
  {
    script: "doc-lint",
