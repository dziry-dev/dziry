...
// readPath lives in its own module: route loaders read data/error paths off their
// exit values with the same walk, and one definition beats two copies drifting.
